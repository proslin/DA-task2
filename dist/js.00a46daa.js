...
var Api = /*#__PURE__*/function () {
  ...
  _createClass(Api, [{
    key: "search",
    value: function () {
      var _search = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(q, pageNum) {
        var result;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                q = "https://openlibrary.org/search.json?q=".concat(q, "&page=").concat(pageNum);
                _context.next = 3;
                return fetch(q);
...
exports.Api = Api;
},{}],"js/to-read.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.ToReadUI = void 0;
...
var ToReadUI = /*#__PURE__*/function () {
  function ToReadUI() {
    _classCallCheck(this, ToReadUI);
  }

  _createClass(ToReadUI, null, [{
    ...
    value: function setToLocalStorage(booksList) {
      localStorage.setItem("booksList", JSON.stringify(booksList));
    }
  }, {
    key: "addNewBookToLocalStorage",
    value: function addNewBookToLocalStorage(bookToAdd) {
      var booksList = ToReadUI.getFromLocalStorage(); //найти по id нет ли этой книги в списке

      var resultBookIndex = booksList.findIndex(function (item) {
        return item.id === bookToAdd.id;
      });
    ...
    value: function getBooksCount() {
      var booksList = ToReadUI.getFromLocalStorage();
      return booksList.length;
    }
  }, {
    key: "getReadBooksCount",
    value: function getReadBooksCount() {
      var booksList = ToReadUI.getFromLocalStorage();
      var readBooksList = booksList.filter(function (item) {
        return item.read == true;
      });
      return readBooksList.length;
    }
  }, {
    key: "renderHeaderReadList",
    value: function renderHeaderReadList() {
      var readListHeader = document.getElementById("readListHeader");
      readListHeader.innerHTML = "To read list...\n    <div class = \"books-count\">\n    <span>".concat(ToReadUI.getBooksCount(), " books</span>\n    <span>").concat(ToReadUI.getReadBooksCount(), " read</span>\n    </div>");
    }
  }, {
    key: "renderReadList",
    value: function renderReadList(booksList) {
    ...
    value: function markAsRead() {
      if (event.target.id.includes("markAsReadBtn")) {
        var bookId = event.target.id.split("/").pop();
        console.log(bookId.split("/").pop());
        var booksList = ToReadUI.getFromLocalStorage();
        console.log(booksList); //найденная книга

        var resultBook = booksList.find(function (item) {
          return item.id === bookId;
        });
        resultBook.read = true;
        ToReadUI.setToLocalStorage(booksList);
        console.log(booksList); //booksList = ToReadUI.getFromLocalStorage();
    ...
    value: function removeFromList() {
      if (event.target.id.includes("RemoveFromListBtn")) {
        ...
        ToReadUI.setToLocalStorage(booksList); //booksList = ToReadUI.getFromLocalStorage();
...
var _toRead = require("./to-read.js");
...
var BooksUI = /*#__PURE__*/function () {
  function BooksUI(api) {
    ...
    _defineProperty(this, "searchResultHolder", void 0);
    ...
    this.searchResultHolder.addEventListener("click", function (event) {
      ...
      if (_this.selectedBook) {
        var _selectedBook = _this.searchResultHolder.querySelector("#" + _this.selectedBook.id);

        _selectedBook.classList.remove("select-book");
      }
      ...
      addToReadListBtn.addEventListener("click", function (event) {
        ...
        var readList = document.getElementById("readListList");
        selectedBooksList = _toRead.ToReadUI.getFromLocalStorage();

        _toRead.ToReadUI.renderReadList(selectedBooksList);
      });
    });
  }
...
},{"./to-read.js":"js/to-read.js"}],"js/variables.js":[function(require,module,exports) {
var API_URL = "https://openlibrary.org/search.json?q=";
...
new _toRead.ToReadUI();

var booksList = _toRead.ToReadUI.getFromLocalStorage();

window.addEventListener('load', _toRead.ToReadUI.renderReadList(booksList));
var readListList = document.getElementById("readListList");
readListList.addEventListener("click", _toRead.ToReadUI.markAsRead);
readListList.addEventListener("click", _toRead.ToReadUI.removeFromList);
},{"regenerator-runtime/runtime":"../node_modules/regenerator-runtime/runtime.js","./api.js":"js/api.js","./books-ui.js":"js/books-ui.js","./variables.js":"js/variables.js","./to-read.js":"js/to-read.js"}],"C:/Users/1/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/1/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/index.js"], null)
